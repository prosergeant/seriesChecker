...
import (
	...
	"github.com/prosergeant/seriesChecker/pkg/handler/auth"
	"github.com/prosergeant/seriesChecker/pkg/handler/progress"
	"github.com/prosergeant/seriesChecker/pkg/handler/series"
...
func main() {
	...
	// mux.HandleFunc("GET /bnsi/{path}", seriesHandler.TheatreStatic)
	// mux.HandleFunc("POST /bnsi/{path}", seriesHandler.TheatreStatic)
